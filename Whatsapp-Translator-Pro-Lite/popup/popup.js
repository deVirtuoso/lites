const LANGUAGES = [
  ...
  ["it", "Italian"], ["pt-br", "Portuguese (Brazil)"], ["pt-pt", "Portuguese"],
  ["ru", "Russian"], ["ja", "Japanese"], ["ko", "Korean"],
  ["zh-cn", "Chinese (Simplified)"], ["zh-tw", "Chinese (Traditional)"],
  ["ar", "Arabic"], ["hi", "Hindi"], ["id", "Indonesian"], ["th", "Thai"],
...
const ids = ["enabled", "bilingualDisplay", "yourLanguage", "contactLanguage", "engine", "color", "outgoingEnabled"]
...
async function load() {
  ...
  if (stored.yourLanguage === undefined) await chrome.storage.local.set({ yourLanguage })
}
